...
<!--                                 <h4 class="m-b-0 text-white">Ajout Clients</h4> -->
<!--                             </div> -->
<!--                             <div class="card-body"> -->
...
<!--                                                     <input type="text" name="nomprenom" id="firstName" class="form-control" placeholder="Ex:Bouna Diawara"> -->
<!--                                                      </div> -->
<!--                                             </div> -->
<!--                                             /span -->
...
<!--                                                            <input type="text" name="adresse"  class="form-control" placeholder="Ex:Mbour"> -->
<!--                                                      </div> -->
<!--                                             </div> -->
<!--                                             /span -->
                        ...
                        <div class="card-body">
                                ...
                                <form action="employe" method="post">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" height="30px">
                                        ...
                                        <tbody>
                                          <c:forEach items="${listeClients}" var="rep">
                                        
                                            <tr>
                                                <td>${rep.codeClient }</td>
                                                <td>${rep.nom }</td>
                                                <td>${rep.adresse }</td>
                                                <td><a href="editer?idEdit=${rep.codeClient}"><button
														type="button" rel="tooltip" title="Modifier"
														class="btn btn-success m-b-10 m-l-5" id="toastr-success-top-right">
														<i class="fa fa-pencil"></i>
										            </button></a>
										            <a href="supprimer?idSup=${rep.codeClient}"><button
